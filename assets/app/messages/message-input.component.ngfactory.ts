...
export function viewFactory_MessageInputComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessageInputComponent> {
  if ((renderType_MessageInputComponent === (null as any))) { (renderType_MessageInputComponent = viewUtils.createRenderComponentType('c:/Users/IBM_ADMIN/Downloads/08 Optimizations/assets/app/messages/message-input.component.html',0,import9.ViewEncapsulation.None,styles_MessageInputComponent,{})); }
